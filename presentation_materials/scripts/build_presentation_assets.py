...
POLICY_RULES = {
    "H0": {
        "rule": "PM due가 0 이하이면 PM Bay로 보내고, 아니면 기본 crusher dispatch를 수행한다.",
        "inputs": "pm_due_hours, demand pressure, next_crusher",
        "hi": "간접",
        "time": "아니오",
        "queue": "아니오",
        "strength": "비교 기준으로 해석이 단순하다.",
        "weakness": "병목, HI risk, queue pressure를 적극적으로 반영하지 못한다.",
    },
    "H1": {
        "rule": "queue/processing 병목이 크면 hold 또는 PM window를 만들고, 아니면 건강한 truck을 dispatch한다.",
        "inputs": "queue_time, demand pressure, truck/tire risk",
        "hi": "예",
        "time": "아니오",
        "queue": "예",
        "strength": "병목 구간에서 불필요한 투입을 줄일 수 있다.",
        "weakness": "생산 압력이 높을 때 과도하게 보수적인 결과가 날 수 있다.",
    },
    "H2": {
    ...
    "H4": {
        ...
        "weakness": "현재 결과에서는 H1과 같은 성능 패턴을 보인다.",
    },
}
