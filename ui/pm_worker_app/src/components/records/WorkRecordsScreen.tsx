  ...
  return (
    <div className="flex-1 overflow-y-auto pb-4 space-y-3 px-4">
      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-border">
        <h2 className="text-sm font-semibold text-text-main mb-3">Work Records</h2>
        <div className="flex justify-around">
          <div className="flex flex-col items-center gap-1">
            <span className="text-lg font-bold text-text-main">{workRecords.summary.last7Days}</span>
            <span className="text-[10px] text-text-sub">Last 7 Days</span>
          </div>
          <div className="flex flex-col items-center gap-1">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-[10px] text-text-sub">Planned Today</span>
          </div>
        </div>
      </div>
          ...
          {workRecords.inProgress.map(item => (
            <div key={item.truckId} className="flex items-center justify-between bg-purple-50/50 rounded-lg p-2">
              <div>
                ...
                <div className="text-[10px] text-text-sub">Started {item.startedAt} · Elapsed {item.elapsed}</div>
              </div>
              <div className="w-12">
