 ...
 *  TCO-relative costRate: H3=1.00 baseline. Values derived from C5.4 30-seed results. */
export const HEURISTIC_TARGETS = {
  H0:     { demandFulfillment: 94, fleetHI: 89, riskTrucks: 1, throughput: 91, costRate: 1.59 },
  H_TIME: { demandFulfillment: 95, fleetHI: 88, riskTrucks: 1, throughput: 93, costRate: 1.55 },
  H1:     { demandFulfillment: 99, fleetHI: 52, riskTrucks: 8, throughput: 118, costRate: 0.95 },
  H2:     { demandFulfillment: 99, fleetHI: 50, riskTrucks: 9, throughput: 117, costRate: 0.94 },
  H3:     { demandFulfillment: 98, fleetHI: 78, riskTrucks: 3, throughput: 108, costRate: 1.00 },
  H4:     { demandFulfillment: 98, fleetHI: 80, riskTrucks: 3, throughput: 106, costRate: 1.00 },
};
