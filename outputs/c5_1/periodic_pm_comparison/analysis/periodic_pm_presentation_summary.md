...
| Queue time | H_PERIODIC | lower is better; leading/tied policy set: H_PERIODIC. |
| PM cost | H1 / H4 | lower is better; leading/tied policy set: H1 / H4. |
| Available trucks | H0 / H1 / H2 / H3 / H4 / H_PERIODIC / H_TIME | higher is better; leading/tied policy set: H0 / H1 / H2 / H3 / H4 / H_PERIODIC / H_TIME. |
