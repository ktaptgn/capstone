...
- Summary CSV: `C:/working/Capstone/outputs/c5_1/time_pm_comparison/summary/policy_comparison.csv`
- Paired JSON summary: `C:/working/Capstone/outputs/c5_1/time_pm_comparison/summary/policy_comparison.json`. Row count matches; policy set matches.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| H_TIME | 0.8800 | 1 | 1 | 1 | 3 | 5 | 1 | 3 |
| H3 | 0.6600 | 2 | 2 | 2 | 6 | 6 | 1 | 6 |
| H0 | 0.6000 | 3 | 3 | 3 | 5 | 3 | 1 | 5 |
| H2 | 0.4600 | 4 | 4 | 4 | 4 | 4 | 1 | 4 |
| H1 | 0.4400 | 5 | 5 | 5 | 1 | 1 | 1 | 1 |
| H4 | 0.4400 | 5 | 5 | 5 | 1 | 1 | 1 | 1 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H2 | 3,339.37 | 15.0894 | 0.0022 | 8.5049 | 8.7178 | 0.0051 | consistently_weak |
...
| H0 | 1,858.65 | 46.3431 | 0.0028 | 20.0333 | 6.9282 | 0.0061 | strong_but_variable |
...
### Weak KPI
- total_downtime, pm_cost

### Interpretation
- H0 ranks best on average_available_trucks and is weakest on total_downtime, pm_cost under the current C5.1 assumptions.
...
### Interpretation
- H1 ranks best on total_downtime, queue_time, average_available_trucks, pm_cost and is weakest on total_cost, demand_fulfillment_rate, unmet_demand under the current C5.1 assumptions.
...
### Interpretation
- H4 ranks best on total_downtime, queue_time, average_available_trucks, pm_cost and is weakest on total_cost, demand_fulfillment_rate, unmet_demand under the current C5.1 assumptions.
